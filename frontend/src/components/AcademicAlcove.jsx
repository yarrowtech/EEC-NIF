...
export default function AcademicAlcove() {
  ...
  return (
    <div className="w-full min-h-screen px-2 sm:px-4 md:px-8 py-4 sm:py-6" style={{background: 'linear-gradient(135deg, #f3e8d7 0%, #e8dcc6 50%, #ddd0bb 100%)'}}>
      ...
      {/* Search & Filters - Only show for problems view */}
      {viewMode === 'problems' && (
              ...
              <div className="p-5">
                <div className="flex flex-wrap gap-2 mb-4">
                  ...
                  <span className={`px-3 py-1 rounded-full text-xs font-semibold capitalize border ${
                    p.difficulty === 'easy' ? 'bg-green-100 text-green-800 border-green-300' :
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          <span className={`px-3 py-1 rounded-full text-xs font-semibold capitalize border ${
                            post.difficulty === 'easy' ? 'bg-green-100 text-green-800 border-green-300' :
      ...
      {/* Enhanced Pagination - Only for problems view */}
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm font-semibold capitalize border ${
                      selected.difficulty === 'easy' ? 'bg-green-200 text-green-800 border-green-400' :
